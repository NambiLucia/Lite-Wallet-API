      ...
      <div className="w-full max-w-md bg-[#C4E2F5] border border-gray-100 rounded-2xl p-6">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
          ...
          <button
            ...
            className="w-full py-3 bg-gray-900 text-white rounded-xl text-sm font-medium hover:bg-gray-600 transition disabled:opacity-50 disabled:cursor-not-allowed"
          >
          ...
          <button
            type="button"
            onClick={() => navigate("/dashboard")}
            className="w-full py-3 border border-gray-400 rounded-xl text-sm text-gray-700 hover:bg-gray-100 transition"
          >
            Cancel
          </button>
